...
path_to_data = '/Volumes/MoritzBertholdHD/CellData/featureExtractionCellProfiler/extracted_data_ex3/'

ch1 = pd.DataFrame.from_csv(path_to_data + 'ex3_data_ch1_no_zeros.csv', header=0, sep=',', index_col=None)
ch2 = pd.DataFrame.from_csv(path_to_data + 'ex3_data_ch2_no_zeros.csv', header=0, sep=',', index_col=None)
ch3 = pd.DataFrame.from_csv(path_to_data + 'ex3_data_ch3_no_zeros.csv', header=0, sep=',', index_col=None)
ch4 = pd.DataFrame.from_csv(path_to_data + 'ex3_data_ch4_no_zeros.csv', header=0, sep=',', index_col=None)
...
np.save('ex_3_data_no_zeros.npy', data_numpy, allow_pickle=True, fix_imports=True)
np.save('ex_3_labels_no_zeros.npy', y_numpy, allow_pickle=True, fix_imports=True)
